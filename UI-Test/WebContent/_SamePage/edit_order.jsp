        ...
        <div class="page-header"> 
            ...
            <div class="page-header-content"> 
                <div class="page-title"> 
                    <h4> <span class="text-semibold">รายการ</span> - แก้ไขรายการ</h4> 
                </div>                 
            </div>             
        </div>         
        <!-- /page header -->         
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input disabled="disabled" class="form-control" placeholder="รหัสรายการ" type="text" value="O111">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <p><input type="text" class="form-control" placeholder="สถานที่รับของ" value="เชียงใหม่"></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <p><input type="text" class="form-control" placeholder="สถานที่ส่งของ" value="เชียงราย"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <select data-placeholder="คนประสานงาน"  class="select" multiple="multiple">
                                                            <option></option>                                                             
                                                            <option ng-repeat="coorList in coors" value="coors">นาย สุรพงค์ ส่องแสง</option>                                                             
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control" placeholder="ค่าคอมมิชชั่นคนประสานงาน" value="500.00" type="text">
                                                </div>
