...
$(function() {
    ...
    $('#sweet_warning').on('click', function() {
        swal({
            title: "คุณแน่ใจ?",
            text: "คุณแน่ใจที่จะยกเลิกสินค้านี่หรือไม่!",
            type: "warning",
            showCancelButton: true,
    ...
    // resign alert
    $('#sweet_resign').on('click', function() {
        swal({
            title: "คุณแน่ใจ?",
            text: "คุณแน่ใจที่พนักงานคนนี้ลาออก!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#FF7043",
            confirmButtonText: "ใช้!"
    ...
    // resign driver alert
    $('#sweet_resign_driver').on('click', function() {
        swal({
            title: "คุณแน่ใจ?",
            text: "คุณแน่ใจที่พนักงานขับรถคนนี้ลาออก!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#FF7043",
            confirmButtonText: "ใช้!"
    ...
    // cancel car alert
    $('#sweet_cancel_car').on('click', function() {
        swal({
            title: "คุณแน่ใจ?",
            text: "คุณแน่ใจที่จะยกเลิกการใช้งานรถคันนี้!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#FF7043",
            confirmButtonText: "ใช้!"
