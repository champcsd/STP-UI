        ...
        <div class="page-header"> 
            ...
            <div class="page-header-content"> 
                <div class="page-title"> 
                    <h4> <span class="text-semibold">ข้อมูลพนักงาน</span> - ข้อมูลพนักงาน</h4> 
                </div>                 
            </div>             
        </div>         
        <!-- /page header -->
                                ...
                                <div class="heading-elements"> 
                                    <div class="btn-group"> 
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right"> 
                                            <li>
                                                <a href="edit_staff_profile.jsp"><i class="fa fa-edit"></i> แก้ไขโปรไฟล์</a>
                                            </li>                                             
                                            <li>
                                                <a href="change_password_staff.jsp"><i class="fa fa-edit"></i>แก้ไขรหัสผ่าน</a>
                                            </li>                                             
                                        </ul>                                         
                                    </div>                                     
                                </div>                                 
