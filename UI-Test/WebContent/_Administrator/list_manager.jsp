...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-header"> 
            <div class="breadcrumb-line breadcrumb-line-wide"> 
                <ul class="breadcrumb"> 
                    <li> 
                        <a href="index.jsp"><i class="fa fa-users"></i>&nbsp;ผู้จัดการ</a> 
                    </li>                     
            ...
            <div class="page-header-content"> 
                <div class="page-title"> 
                    <h4> <span class="text-semibold">ผู้จัดการ</span> - รายการผู้จัดการ</h4> 
                </div>                 
            </div>             
        </div>         
        <!-- /page header -->
                    ...
                    <div class="panel panel-flat"> 
                        <div class="panel-heading"> 
                            ...
                            <div class="heading-elements">
                                <button class="btn btn-default btn-sm pull-right" data-toggle="modal" data-target="#modal_manager" type="button">เพิ่มผู้จัดการ</button>
                            </div>
                        </div>                         
   ...
   <%@ include file="add_manager_modal.jsp" %> 
</html>
