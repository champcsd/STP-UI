        ...
        <div class="page-header"> 
            <div class="breadcrumb-line breadcrumb-line-wide"> 
                <ul class="breadcrumb"> 
                    ...
                    <li class="active">โปรไฟล์ของฉัน</li>                     
                </ul>                 
            </div>             
            <div class="page-header-content"> 
                <div class="page-title"> 
                    <h4> <span class="text-semibold">โปรไฟล์</span> - โปรไฟล์ของฉัน</h4> 
                </div>                 
            </div>             
        </div>         
        <!-- /page header -->         
                    ...
                    <form class="form-horizontal" action="#"> 
                        <div class="panel panel-flat"> 
                            <div class="panel-heading"> 
                                <h5 class="panel-title">โปรไฟล์ของฉัน</h5> 
                                <div class="heading-elements"> 
                                    <div class="btn-group"> 
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right"> 
                                            <li>
                                                <a href="edit_myprofile.jsp"><i class="fa fa-edit"></i> แก้ไขโปรไฟล์</a>
                                            </li>                                             
                                        </ul>                                         
                                    </div>                                     
                                </div>                                 
                            ...
                            <div class="panel-body"> 
                                <fieldset> 
                                    <legend class="text-semibold">ข้อมูลโปรไฟล์ของฉัน</legend>                                     
                                ...
                                <fieldset> 
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-lg-9"> 
                                            <div class="row"> 
                                                <div class="col-md-3"> 
                                                    <label class="col-lg-6 control-label">นิคมพัฒนา</label>                                                     
                                                </div>                                                 
